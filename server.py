...
@log
def server_answer_out(message, messages_list, client):
    """
    ...
    if ACTION in message and message[ACTION] == PRESENCE and TIME in message \
        ...
        message_out(client, {RESPONSE: 200})
        return
    ...
    while True:
        ...
        if recv_data_lst:
            for client_with_message in recv_data_lst:
                try:
                    server_answer_out(message_in(client_with_message),
        ...
        if messages and send_data_lst:
            ...
            for waiting_client in send_data_lst:
                try:
                    message_out(waiting_client, message)
                except:
