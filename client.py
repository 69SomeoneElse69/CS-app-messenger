...
from common.utils import message_in, message_out
...
def user_interactive(sock, username):
    ...
    while True:
        ...
        if command == 'message':
            ...
            message_out(sock, create_exit_message(username))
...
@log
def is_client_here(account_name):
...
def main():
    ...
    try:
        ...
        message_out(transport, is_client_here(client_name))
        answer = server_answer_in(message_in(transport))
